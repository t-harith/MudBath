...
public:
    Chameleon() {};
    explicit Chameleon(const std::string &, const std::string & type);
//    explicit Chameleon(double, const std::string & type);
    explicit Chameleon(const char*, const std::string & type);
